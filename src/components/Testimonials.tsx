      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto mb-16 bg-white/70 backdrop-blur-md border border-clinic-100/50 p-6 rounded-3xl text-center">
          ...
          <div className="border-y sm:border-y-0 sm:border-x border-clinic-100/80 py-4 sm:py-0">
            ...
            <p className="text-xs font-semibold text-warmneutral-800 mt-1">Patients satisfaits du cabinet</p>
          </div>
          <div>
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <div className="relative bg-white rounded-3xl border-2 border-sky-500/80 hover:border-ruby-500 p-8 sm:p-12 shadow-[0_4px_24px_rgba(56,189,248,0.25),0_4px_24px_rgba(225,29,72,0.25)] overflow-hidden min-h-[350px] flex flex-col justify-between">
          ...
          <div className="flex justify-center sm:justify-end gap-3 mt-6">
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              onClick={handlePrev}
              className="p-3 bg-gradient-to-br from-white via-sky-50/20 to-ruby-50/20 text-clinic-600 border border-clinic-100 hover:bg-clinic-50 rounded-full shadow-md transition-colors cursor-pointer"
